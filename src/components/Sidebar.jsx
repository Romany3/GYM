...
export default function Sidebar({ activeTab, setActiveTab, onQuickAddClient }) {
  const navItems = [
  ...
  return (
    <aside className="w-64 bg-[#0a0d16] border-r border-slate-800/80 flex flex-col justify-between h-screen sticky top-0 select-none z-20 shrink-0">
